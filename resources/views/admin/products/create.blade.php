...
<div class="form-card">
  <form method="POST" action="/admin/products" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="image">Foto Utama Produk</label>
      ...
      <div class="preview-wrap">
        <img id="imagePreview" src="" alt="Preview gambar produk" class="preview-image">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="gallery_videos">Video Produk</label>
    ...
    <div class="form-group">
      ...
      <textarea id="description" name="description" placeholder="Deskripsikan produk ini dengan poin atau baris baru agar lebih rapi...">{{ old('description') }}</textarea>
      <div class="help">Tips: gunakan baris baru atau tanda "-" supaya deskripsi panjang tampil lebih rapi di halaman detail.</div>
    </div>
    <div class="form-group">
      <label for="english_description">Deskripsi English</label>
      <textarea id="english_description" name="english_description" placeholder="Describe this product in English...">{{ old('english_description') }}</textarea>
      <div class="help">Opsional, tapi wajib diisi jika Anda ingin deskripsi ikut berubah saat user memilih bahasa Inggris.</div>
    </div>
    <div class="form-group">
